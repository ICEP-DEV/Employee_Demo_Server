...
router.post('/register_employee', function (req, res) {
    var sql_body = [req.body.firstname, req.body.lastname, req.body.salary, req.body.userId]
    var sql = `insert into employee(firstname, lastname, salary, userId)
                values(?,?,?,?)`
